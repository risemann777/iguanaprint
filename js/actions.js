var page_actions = function(){
    ...
    $('#frame_right').click(function(){
        if($('.dinamic').hasClass('show_frame')){
            $('.dinamic').removeClass('show_frame');
            $('.page-container .page-content .content-frame .content-frame-body.content-frame-body-left').css('margin-right','0px');
            $('#t_rf').css('margin-right','0px');
        } else {
            $('.dinamic').addClass('show_frame');
            $('.page-container .page-content .content-frame .content-frame-body.content-frame-body-left').css('margin-right','300px');
            $('#t_rf').css('margin-right','300px');
        }
    });
